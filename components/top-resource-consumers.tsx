      ...
      <CardContent>
        <div className="space-y-3">
          {topResources.map((resource, index) => {
            ...
            const productName = resource.metadata?.product || resource.resource_name || 'Unknown Product'
            const productDescription = resource.metadata?.description
            const shouldShowDescription = productDescription && productDescription !== productName
